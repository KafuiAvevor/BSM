...
risk_free_rate = col2.number_input("Risk Free Rate", min_value=0.00, value=0.05)
...
spot_range = np.linspace(0.5 * spot_price, 1.5 * spot_price, 10)  # 10 different spot prices
volatility_range = np.linspace(0.5 * volatility, 1.5 * volatility , 10)  # 10 different volatilities
